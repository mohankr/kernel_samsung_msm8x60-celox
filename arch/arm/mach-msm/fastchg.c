 ...
 * Ported to Skyrocket: mohan_kr <mohankr03@gmail.com>
 * 
...
int force_fast_charge_init(void)
{
  ...
  is_fast_charge_forced_retval = sysfs_create_group(force_fast_charge_kobj,
    &is_fast_charge_forced_attr_group);
  current_charge_mode_retval = sysfs_create_group(force_fast_charge_kobj,
    &current_charge_mode_attr_group);
  if (force_fast_charge_retval
    && is_fast_charge_forced_retval 
