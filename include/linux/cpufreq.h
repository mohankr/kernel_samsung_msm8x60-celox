...
#define MAX_FREQ_LIMIT    CONFIG_MAX_CPU_FREQ_CUTOFF
#else
#define MAX_FREQ_LIMIT		1512000
#endif

#if defined(CONFIG_ACPU_OVERCLOCK) && defined(CONFIG_MIN_CPU_FREQ_CUTOFF)
#define MIN_FREQ_LIMIT    CONFIG_MIN_CPU_FREQ_CUTOFF
#else
